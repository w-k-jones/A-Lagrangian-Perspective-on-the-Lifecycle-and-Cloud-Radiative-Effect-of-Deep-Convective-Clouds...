...
However, the closer spacing and narrower bandwidth of the \acrshort{seviri} \acrshort{lw} window channels (see supplementary fig. S2), along with the higher noise means that the \acrshort{swd} is less sensitive to thin cirrus compared to instruments such as the \acrshort{goes}-16 \acrshort{abi} (see supplementary fig. S3).
...
The dataset of tracked DCCs and their properties used in this study is available at the following repository: \url{https://zenodo.org/record/8317025} \citep{jones_cloudcci_2023}.
